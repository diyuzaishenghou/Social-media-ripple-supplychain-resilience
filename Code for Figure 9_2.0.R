...
# 第一步读取数据框，并且筛选出相关的数据
result_data <- read.csv("C:/Users/Administrator/Desktop/【小论文A】新媒体传播条件下，如何快速部署供应链和销售网络？/final_result/final_result_Gama_NA_NA.csv", header = TRUE)
...
output_file <- paste0(data_path, "Figure_9_combined.pdf")
